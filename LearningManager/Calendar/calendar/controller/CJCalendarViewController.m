...
-(CJShowTimeView *)timeView{
    if (!_timeView) {
        ...
        CGRect rect = CGRectMake(0, 0, timeRectWidth, timeRectHeight);
...
-(void) setSelectTime{
    ...
    CGRect selectRect = CGRectMake(0, 15 + self.viewHeight, self.view.bounds.size.width, selectHeight);
...
-(void) setDecision{
    ...
    CGRect rect = CGRectMake(0, self.viewHeight, self.view.bounds.size.width, selectHeight);
